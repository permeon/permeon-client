...
const AccountSelector = ({ isLoggedIn, activeAccount, accounts, onAccountClick }) => {
  return isLoggedIn ? (
    <Dropdown
      item
      trigger={
        <div>
          <Avatar username={activeAccount} />
          {activeAccount}
        </div>
      }
    >
...
export default connect(mapStateToProps, { onAccountClick: setActiveAccount })(AccountSelector);
